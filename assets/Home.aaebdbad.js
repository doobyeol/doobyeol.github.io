import{d as x,r as n,a as p,o as A,c as D,b as B,e as J,p as T,f as P,_ as g,s as m,t as E,u as r,n as y,g as S,h as d,i as $,F as _,j as F,k,l as f,m as b}from"./index.89ff782e.js";const j=x("bubbleStore",()=>{const u=n(!1),t=n(null),o=n(null),C=n(),s=n(),l=()=>{u.value=!0,C.value=setTimeout(()=>{u.value=!1},1500)},e=()=>{clearTimeout(C.value),clearTimeout(s.value)};return{isShowBubble:u,showBubble:l,onEmoji:c=>{e(),t.value=c,o.value=null,l()},onText:c=>{e(),t.value=null,o.value=c,l()},isEmoji:t,isText:o,clearBubbleAll:e}}),L=u=>(T("data-v-bf70601f"),u=u(),P(),u),M={class:"profileWrap"},w=L(()=>B("div",{class:"cover"},null,-1)),I=J('<ul class="txt" data-v-bf70601f><li class="name" data-v-bf70601f>\uB450\uBCC4</li><li data-v-bf70601f>Web Developer</li><li class="flex gray" data-v-bf70601f><a href="https://www.google.co.kr/maps/place/%EC%84%9C%EC%9A%B8%ED%8A%B9%EB%B3%84%EC%8B%9C+%EC%98%81%EB%93%B1%ED%8F%AC%EC%8B%9C%EC%9E%A5%EC%97%AD%EC%95%9E" target="_blink" data-v-bf70601f><span class="pin" data-v-bf70601f></span> Seoul </a></li><li class="flex gray" data-v-bf70601f><a href="mailto:doobyeol@gmail.com" data-v-bf70601f><span class="mail" data-v-bf70601f></span> doobyeol@gmail.com </a></li><li class="flex" data-v-bf70601f><a href="https://velog.io/@doobyeol" target="_blink" class="velog icon" title="velog" data-v-bf70601f></a><a href="https://github.com/doobyeol" target="_blink" class="github icon" title="github" data-v-bf70601f></a></li></ul>',1),V=p({__name:"Profile",setup(u){const t=j(),o=n(["hello, world !","\uBC30\uACE0\uD504\uB2E4..","\uC624\uB298 \uBB50\uBA39\uC9C0..","\uBD88\uC744 \uB044\uACE0 \uB098\uC654\uC5C8\uB098?..","\uB204\uAC00 \uC790\uAFB8 \uAC74\uB4DC\uB294 \uB290\uB08C..","\uADF8\uB9CC \uB20C\uB7EC!..","\uC0AC\uC2E4 \uC88B\uC544..","\uC774\uACF3\uC5D0 \uC640\uC918\uC11C \uACE0\uB9C8\uC6CC","\uC624\uB298 \uD558\uB8E8 \uD589\uC6B4\uC774 \uAC00\uB4DD\uD574","\uC88B\uC740 \uC77C\uC774 \uC77C\uC5B4\uB0A0\uAC70\uC57C","no need be best","only good and kind !"]),C=n(0);function s(){t.onEmoji("heart")}function l(){t.onText(o.value[C.value]),C.value++,o.value.length==C.value&&(C.value=0)}return(e,a)=>(A(),D("div",M,[B("div",{class:"content"},[w,B("div",{class:"profile"},[B("div",{class:"pic",onClick:l})]),B("div",{class:"button"},[B("a",{onClick:s})])]),I]))}});const O=g(V,[["__scopeId","data-v-bf70601f"]]),W=p({__name:"Bubble",setup(u){const t=j(),{isShowBubble:o,isEmoji:C,isText:s}=m(t);return(l,e)=>(A(),D("div",{class:y(["bubbleWrafp",r(o)?"":"hide"])},[B("p",{class:y(r(C)?r(C):"")},E(r(s)?r(s):""),3)],2))}});const N=g(W,[["__scopeId","data-v-d8f48e23"]]),h=x("timelineStore",()=>{const u=n([{date:"20221124",type:"introduction",title:"Skills and Languages",text:"",link:"",imgPath:""}]),t=n([{date:"20221124",type:"career",title:`\u321C\uC5D0\uC2A4\uD53C\uC5D0\uC774\uCE58 (\uD074\uB77C\uC6B0\uB4DC\uD300 \uC0AC\uC6D0)
                    2021.07 - \uD604\uC7AC`,text:`
            ...
            `,link:"https://github.com/doobyeol/SeoulMate",imgPath:"/img/project/seoulmate_01.png"},{date:"20221124",type:"career",title:"\uD559\uB825",text:`
                ...
                2012.03 ~ 2014.02 
                \uC11C\uC6B8\uB514\uC790\uC778\uACE0\uB4F1\uD559\uAD50 - \uC601\uC0C1\uB514\uC790\uC778\uACFC \uC878\uC5C5
            `,link:"",imgPath:""}]),o=n("introduction"),C=a=>{o.value=a};function s(){let a=new Date;const i=a.getFullYear(),c=("0"+(a.getMonth()+1)).slice(-2),v=("0"+a.getDate()).slice(-2);return`${i}${c}${v}`}const l=async()=>{if(t.value.filter(c=>c.type=="blog").length>0)return;let a="https://proxy.cors.sh/https://v2.velog.io/graphql";const i=JSON.stringify({query:`
            ...
            `,variables:{username:"doobyeol",limit:100}});try{const v=await(await fetch(a,{method:"POST",headers:{"Content-Type":"application/json",Origin:"application/json","x-cors-api-key":"00e153e0-570e-4d2a-bd2a-114da7b4674a"},body:i})).json();e(v.data.posts)}catch{t.value.push({date:s(),type:"blog",title:"[ \uBE14\uB85C\uADF8\uC5D0 \uB180\uB7EC\uC624\uC138\uC694! ]",text:"\uACBD\uD5D8\uC744 \uAE30\uB85D\uD569\uB2C8\uB2E4.",link:"https://velog.io/@doobyeol",imgPath:"/img/timeline/blog_info.PNG"})}};function e(a){for(const i of a)t.value.push({date:i.released_at,type:"blog",title:`[ ${i.title} ]`,text:`${i.short_description.substr(0,25)}...`,link:"https://velog.io/@doobyeol/"+i.url_slug,imgPath:i.thumbnail})}return{timelineList:t,activeTab:o,moveTab:C,fixedArticle:u,getPostList:l}}),G=u=>(T("data-v-b19197bb"),u=u(),P(),u),U={key:0,class:"timelineWrap"},R={class:"content"},H=G(()=>B("div",{class:"profile"},[B("div",{class:"img"}),B("p",{class:"name"},"\uB450\uBCC4")],-1)),X={class:"column"},K={class:"preLine"},Q=["href"],q={key:0,class:"img"},z=["href"],Y=["src"],Z=p({__name:"Timeline",props:{item:null},setup(u){const t=h(),{activeTab:o}=m(t);return(C,s)=>u.item.type==r(o)?(A(),D("div",U,[B("div",R,[H,B("div",X,[B("p",K,[B("b",null,E(u.item.title),1),S(" "+E(u.item.text)+" ",1),u.item.link?(A(),D("a",{key:0,target:"_blink",href:u.item.link},E(u.item.link),9,Q)):d("",!0)]),u.item.imgPath?(A(),D("div",q,[B("a",{target:"_blink",href:u.item.link?u.item.link:"/"},[B("img",{src:u.item.imgPath,width:"100%",height:"100%"},null,8,Y)],8,z)])):d("",!0)])])])):d("",!0)}});const uu=g(Z,[["__scopeId","data-v-b19197bb"]]),Cu={class:"tabWrap"},Bu={class:""},tu=["onClick"],eu=p({__name:"Tab",setup(u){const t=h(),{activeTab:o}=m(t);$(()=>{l()});const C=n([{class:"active",text:"\uC18C\uAC1C",type:"introduction"},{class:"",text:"\uACBD\uB825",type:"career"},{class:"",text:"\uD504\uB85C\uC81D\uD2B8",type:"project"},{class:"",text:"\uBE14\uB85C\uADF8",type:"blog"}]);function s(e){t.moveTab(e.type),l()}function l(){C.value=C.value.filter(e=>(e.type==o.value?e.class="active":e.class="",e))}return(e,a)=>(A(),D("div",Cu,[B("ul",Bu,[(A(!0),D(_,null,F(C.value,i=>(A(),D("li",{key:i.type,onClick:c=>s(i)},[B("p",{class:y(i.class)},E(i.text),3)],8,tu))),128))])]))}});const ou=g(eu,[["__scopeId","data-v-ce4b6dca"]]),Au={class:"badge"},Du=["src"],iu=p({__name:"Badge",props:{items:null},setup(u){return(t,o)=>(A(),D("ul",Au,[(A(!0),D(_,null,F(u.items,C=>(A(),D("li",{key:C.value,style:k({backgroundColor:C.color})},[B("img",{src:C.logo,style:k({width:C.logo?"13px":"0px"})},null,12,Du),S(" "+E(C.value),1)],4))),128))]))}});const su=g(iu,[["__scopeId","data-v-963d6ffd"]]),lu={key:0,class:"timelineWrap"},au={class:"content"},nu={class:"profile"},cu={class:"column"},ru={class:"preLine"},Eu=["href"],du={key:0,class:"img"},pu=["href"],gu=["src"],mu=p({__name:"PixArticle",props:{item:null},setup(u){const t=h(),{activeTab:o}=m(t),C=n([{value:"Java",color:"#5283a2"},{value:"Spring",color:"#62a458",logo:"https://simpleicons.org/icons/spring.svg"},{value:"Oracle",color:"#ae2525",logo:"https://simpleicons.org/icons/oracle.svg"},{value:"PostgreSQL",color:"#526e8e",logo:"https://simpleicons.org/icons/postgresql.svg"},{value:"Node.js",color:"#759c60",logo:"https://simpleicons.org/icons/nodedotjs.svg"},{value:"Vue.js",color:"#11b48a",logo:"https://simpleicons.org/icons/vuedotjs.svg"},{value:"JavaScript",color:"#f5b33c",logo:"https://simpleicons.org/icons/javascript.svg"},{value:"TypeScript",color:"#1c63b3",logo:"https://simpleicons.org/icons/typescript.svg"},{value:"SCSS",color:"#c9469d",logo:"https://simpleicons.org/icons/sass.svg"},{value:"Git",color:"#3e3e4a",logo:"https://simpleicons.org/icons/git.svg"},{value:"Docker",color:"#0090db",logo:"https://simpleicons.org/icons/docker.svg"}]);return(s,l)=>u.item.type==r(o)?(A(),D("div",lu,[B("div",au,[B("div",nu,[B("b",null,E(u.item.title),1)]),B("div",cu,[B("p",ru,[u.item.type=="introduction"?(A(),f(su,{key:0,items:C.value},null,8,["items"])):d("",!0),S(" "+E(u.item.text)+" ",1),u.item.link?(A(),D("a",{key:1,target:"_blink",href:u.item.link},E(u.item.link),9,Eu)):d("",!0)]),u.item.imgPath?(A(),D("div",du,[B("a",{target:"_blink",href:u.item.link?u.item.link:"/"},[B("img",{src:u.item.imgPath,width:"100%",height:"100%"},null,8,gu)],8,pu)])):d("",!0)])])])):d("",!0)}});const _u=g(mu,[["__scopeId","data-v-594a60b7"]]),Fu={class:"contentWrap"},vu=p({__name:"Home",setup(u){const t=h(),{timelineList:o,fixedArticle:C}=m(t);return $(()=>{t.getPostList(),console.log(`
    %c
      \u2588\u2588\u2588\u2588\u2588\u2588\u2557 \u2588\u2588\u2557 \u2588\u2588\u2588\u2588\u2588\u2588\u2557\u2588\u2588\u2557  \u2588\u2588\u2557    \u2588\u2588\u2588\u2557   \u2588\u2588\u2588\u2557\u2588\u2588\u2588\u2588\u2588\u2588\u2588\u2557    \u2588\u2588\u2557
      \u2588\u2588\u2554\u2550\u2550\u2588\u2588\u2557\u2588\u2588\u2551\u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D\u2588\u2588\u2551 \u2588\u2588\u2554\u255D    \u2588\u2588\u2588\u2588\u2557 \u2588\u2588\u2588\u2588\u2551\u2588\u2588\u2554\u2550\u2550\u2550\u2550\u255D    \u2588\u2588\u2551
      \u2588\u2588\u2588\u2588\u2588\u2588\u2554\u255D\u2588\u2588\u2551\u2588\u2588\u2551     \u2588\u2588\u2588\u2588\u2588\u2554\u255D     \u2588\u2588\u2554\u2588\u2588\u2588\u2588\u2554\u2588\u2588\u2551\u2588\u2588\u2588\u2588\u2588\u2557      \u2588\u2588\u2551
  ...
  `,"color: #bc849c")}),(s,l)=>(A(),D("div",Fu,[b(O),b(N),b(ou),(A(!0),D(_,null,F(r(C),e=>(A(),f(_u,{key:e.title,item:e},null,8,["item"]))),128)),(A(!0),D(_,null,F(r(o),e=>(A(),f(uu,{key:e.title,item:e},null,8,["item"]))),128))]))}});export{vu as default};
