import{d,o as t,c as D,a as x,_ as g,b as T,r as p,s as _,u as m,e as C,t as a,f as b,g as c,p as $,h as J,i as P,F as h,j as F,n as j,k as f,l as y,m as k}from"./index.16c7419e.js";const L={class:"profileWrap"},M=x('<div class="content" data-v-62195d5e><div class="cover" data-v-62195d5e></div><div class="profile" data-v-62195d5e><div class="pic" data-v-62195d5e></div></div><div class="button" data-v-62195d5e><a href="https://github.com/doobyeol" target="_blink" data-v-62195d5e></a></div></div><ul class="txt" data-v-62195d5e><li class="name" data-v-62195d5e>\uB450\uBCC4</li><li data-v-62195d5e>Web Developer</li><li class="flex gray" data-v-62195d5e><span class="pin" data-v-62195d5e></span> Seoul</li><li class="flex gray" data-v-62195d5e><a href="mailto:doobyeol@gmail.com" data-v-62195d5e><span class="mail" data-v-62195d5e></span> doobyeol@gmail.com </a></li><li class="flex" data-v-62195d5e><a href="https://velog.io/@doobyeol" target="_blink" class="velog icon" title="velog" data-v-62195d5e></a><a href="https://github.com/doobyeol" target="_blink" class="github icon" title="github" data-v-62195d5e></a></li></ul>',2),I=[M],V=d({__name:"Profile",setup(u){return(B,i)=>(t(),D("div",L,I))}});const O=g(V,[["__scopeId","data-v-62195d5e"]]),v=T("timelineStore",()=>{const u=p([{date:"20221124",type:"introduction",title:"Skills and Languages",text:"",link:"",imgPath:""}]),B=p([{date:"20221124",type:"career",title:`\u321C\uC5D0\uC2A4\uD53C\uC5D0\uC774\uCE58 (\uD074\uB77C\uC6B0\uB4DC\uD300 \uC0AC\uC6D0)
            ...
            `,variables:{username:"doobyeol",limit:100}});try{const n=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Origin:"application/json"},body:A})).json();console.log("########## postsData",n.data),o(n.data.posts)}catch(l){console.log(l),s="https://cors-anywhere.herokuapp.com/https://v2.velog.io/graphql";try{const S=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Origin:"application/json"},body:A})).json();console.log("########## postsData",S.data),o(S.data.posts)}catch(n){console.log(n),B.value.push({date:r(),type:"blog",title:"[ \uBE14\uB85C\uADF8\uC5D0 \uB180\uB7EC\uC624\uC138\uC694! ]",text:"\uACBD\uD5D8\uC744 \uAE30\uB85D\uD569\uB2C8\uB2E4.",link:"https://velog.io/@doobyeol",imgPath:"/img/timeline/blog_info.PNG"})}}};function o(s){for(const A of s)B.value.push({date:A.released_at,type:"blog",title:`[ ${A.title} ]`,text:`${A.short_description.substr(0,25)}...`,link:"https://velog.io/@doobyeol/"+A.url_slug,imgPath:A.thumbnail})}return{timelineList:B,activeTab:i,moveTab:e,fixedArticle:u,getPostList:E}}),N=u=>($("data-v-b19197bb"),u=u(),J(),u),W={key:0,class:"timelineWrap"},w={class:"content"},G=N(()=>C("div",{class:"profile"},[C("div",{class:"img"}),C("p",{class:"name"},"\uB450\uBCC4")],-1)),U={class:"column"},R={class:"preLine"},H=["href"],X={key:0,class:"img"},q=["href"],K=["src"],Q=d({__name:"Timeline",props:{item:null},setup(u){const B=v(),{activeTab:i}=_(B);return(e,r)=>u.item.type==m(i)?(t(),D("div",W,[C("div",w,[G,C("div",U,[C("p",R,[C("b",null,a(u.item.title),1),b(" "+a(u.item.text)+" ",1),u.item.link?(t(),D("a",{key:0,target:"_blink",href:u.item.link},a(u.item.link),9,H)):c("",!0)]),u.item.imgPath?(t(),D("div",X,[C("a",{target:"_blink",href:u.item.link?u.item.link:"/"},[C("img",{src:u.item.imgPath,width:"100%",height:"100%"},null,8,K)],8,q)])):c("",!0)])])])):c("",!0)}});const z=g(Q,[["__scopeId","data-v-b19197bb"]]),Y={class:"tabWrap"},Z={class:""},uu=["onClick"],Cu=d({__name:"Tab",setup(u){const B=v(),{activeTab:i}=_(B);P(()=>{E()});const e=p([{class:"active",text:"\uC18C\uAC1C",type:"introduction"},{class:"",text:"\uACBD\uB825",type:"career"},{class:"",text:"\uD504\uB85C\uC81D\uD2B8",type:"project"},{class:"",text:"\uBE14\uB85C\uADF8",type:"blog"}]);function r(o){B.moveTab(o.type),E()}function E(){e.value=e.value.filter(o=>(o.type==i.value?o.class="active":o.class="",o))}return(o,s)=>(t(),D("div",Y,[C("ul",Z,[(t(!0),D(h,null,F(e.value,A=>(t(),D("li",{key:A.type,onClick:l=>r(A)},[C("p",{class:j(A.class)},a(A.text),3)],8,uu))),128))])]))}});const tu=g(Cu,[["__scopeId","data-v-ce4b6dca"]]),Bu={class:"badge"},eu=["src"],ou=d({__name:"Badge",props:{items:null},setup(u){return(B,i)=>(t(),D("ul",Bu,[(t(!0),D(h,null,F(u.items,e=>(t(),D("li",{key:e.value,style:f({backgroundColor:e.color})},[C("img",{src:e.logo,style:f({width:e.logo?"13px":"0px"})},null,12,eu),b(" "+a(e.value),1)],4))),128))]))}});const Du=g(ou,[["__scopeId","data-v-963d6ffd"]]),Au={key:0,class:"timelineWrap"},iu={class:"content"},su={class:"profile"},au={class:"column"},lu={class:"preLine"},nu=["href"],cu={key:0,class:"img"},ru=["href"],Eu=["src"],du=d({__name:"PixArticle",props:{item:null},setup(u){const B=v(),{activeTab:i}=_(B),e=p([{value:"Java",color:"#5283a2"},{value:"Spring",color:"#62a458",logo:"https://simpleicons.org/icons/spring.svg"},{value:"Oracle",color:"#ae2525",logo:"https://simpleicons.org/icons/oracle.svg"},{value:"PostgreSQL",color:"#526e8e",logo:"https://simpleicons.org/icons/postgresql.svg"},{value:"Node.js",color:"#759c60",logo:"https://simpleicons.org/icons/nodedotjs.svg"},{value:"Vue.js",color:"#11b48a",logo:"https://simpleicons.org/icons/vuedotjs.svg"},{value:"JavaScript",color:"#f5b33c",logo:"https://simpleicons.org/icons/javascript.svg"},{value:"TypeScript",color:"#1c63b3",logo:"https://simpleicons.org/icons/typescript.svg"},{value:"SCSS",color:"#c9469d",logo:"https://simpleicons.org/icons/sass.svg"},{value:"Git",color:"#3e3e4a",logo:"https://simpleicons.org/icons/git.svg"},{value:"Docker",color:"#0090db",logo:"https://simpleicons.org/icons/docker.svg"}]);return(r,E)=>u.item.type==m(i)?(t(),D("div",Au,[C("div",iu,[C("div",su,[C("b",null,a(u.item.title),1)]),C("div",au,[C("p",lu,[u.item.type=="introduction"?(t(),y(Du,{key:0,items:e.value},null,8,["items"])):c("",!0),b(" "+a(u.item.text)+" ",1),u.item.link?(t(),D("a",{key:1,target:"_blink",href:u.item.link},a(u.item.link),9,nu)):c("",!0)]),u.item.imgPath?(t(),D("div",cu,[C("a",{target:"_blink",href:u.item.link?u.item.link:"/"},[C("img",{src:u.item.imgPath,width:"100%",height:"100%"},null,8,Eu)],8,ru)])):c("",!0)])])])):c("",!0)}});const pu=g(du,[["__scopeId","data-v-594a60b7"]]),gu={class:"contentWrap"},hu=d({__name:"Home",setup(u){const B=v(),{timelineList:i,fixedArticle:e}=_(B);return P(()=>{B.getPostList()}),(r,E)=>(t(),D("div",gu,[k(O),k(tu),(t(!0),D(h,null,F(m(e),o=>(t(),y(pu,{key:o.title,item:o},null,8,["item"]))),128)),(t(!0),D(h,null,F(m(i),o=>(t(),y(z,{key:o.title,item:o},null,8,["item"]))),128))]))}});export{hu as default};
